...
#print(clusters['HostHaloID'].iloc[74],clusters.shape[0])
        ...
        with open(f'{Fofd}FoF.{snapno:0>5}/GALFIND.DATA.{snapno:0>5}', mode='rb') as file: # b -> binary
            ...
            while True:
                ...
                if not fof or (hline>clusno):
                    ...
                    #                 print(hline,clusters['HostHaloID'].iloc[kkk])
                                    ...
                                    print(f"Cluster found!! {clusno}{hline}")
